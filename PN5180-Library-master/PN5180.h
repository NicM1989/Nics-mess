...
//****Edits made by Nic Morgan August 31 2019*****
// Defined extra registers for reading configuration regs in the EEPROM of PN5180
// 
//
#ifndef PN5180_H
#define PN5180_H
...
#define RF_STATUS           (0x1d) 			//bits 9:0 are AGC_VALUE set to 0 = most sensitive 3FF = most robust
#define SYSTEM_STATUS       (0x24)
#define TEMP_CONTROL        (0x25)
#define AGC_CONFIG			(0x1E)			// automatic gain control for RX card reciever signal
#define LD_CONTROL			(0x25)			//level detection
